        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-3 sm:gap-4">
            ...
            <div>
              ...
              <p className="text-xs text-[#b9bbbe] hidden sm:block">Общайся свободно — быстро, безопасно, удобно</p>
            </div>
          </div>
        ...
        <div className="flex-1 flex flex-col lg:flex-row">
          ...
          >
            ...
            <div className="flex-1 p-2">
              ...
              <div>
                ...
                <div className="mt-1 space-y-0.5">
                  {["Общий чат", "Тихий уголок"].map((channel) => (
                    <div
                      key={channel}
                      className="flex items-center gap-1.5 px-2 py-1 rounded text-[#8e9297] hover:text-[#dcddde] hover:bg-[#393c43] cursor-pointer"
                    >
            ...
            <div className="p-2 bg-[#292b2f] flex items-center gap-2">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="text-[#b9bbbe] text-xs truncate">#5678</div>
              </div>
          ...
          <div className="flex-1 flex flex-col">
            ...
            <div className="h-12 bg-[#36393f] border-b border-[#202225] flex items-center px-4 gap-2">
              ...
              <span className="text-[#8e9297] text-sm hidden sm:block">Общайся с кем угодно — просто и безопасно</span>
            ...
            <div className="flex-1 p-2 sm:p-4 space-y-4 sm:space-y-6 overflow-y-auto">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="text-[#dcddde] text-sm sm:text-base">
                    <p className="mb-3 sm:mb-4">
                      <strong>Добро пожаловать!</strong> Мессенджер — это место, где общение становится проще, быстрее и безопаснее.
                    </p>
                    <div className="bg-[#2f3136] border-l-4 border-[#5865f2] p-3 sm:p-4 rounded">
                      <h3 className="text-white font-semibold mb-2 text-sm sm:text-base">Что умеет Мессенджер:</h3>
                      <ul className="space-y-1 text-xs sm:text-sm text-[#b9bbbe]">
                        <li>Мгновенные сообщения с доставкой в реальном времени</li>
                        <li>Голосовые и видеозвонки с высоким качеством</li>
                        <li>Групповые чаты и каналы для сообществ</li>
                        <li>Сквозное шифрование — ваши данные в безопасности</li>
                        <li>Работает на всех устройствах без потери истории</li>
                      </ul>
                    </div>
                  </div>
                </div>
              ...
              <div className="flex gap-2 sm:gap-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="text-[#dcddde] mb-3 text-sm sm:text-base">
                    Наконец-то нормальный мессенджер! Всё работает молниеносно 🔥
                  </div>
                      ...
                      <div className="mb-3 sm:mb-4">
                        <div className="bg-[#36393f] rounded-lg p-2 sm:p-3 relative">
                          ...
                          <div className="flex items-center gap-2 text-[#dcddde] text-xs sm:text-sm">
                            ...
                            <span>Общаюсь со всеми здесь ✨</span>
                          </div>
                        </div>
                      </div>
                      ...
                      <div>
                        ...
                        <div className="flex items-start gap-2 sm:gap-3 p-2 sm:p-3 bg-[#36393f] rounded-lg">
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <div className="text-[#dcddde] text-xs sm:text-sm mb-1">Чат: #общий</div>
                            <div className="text-[#b9bbbe] text-xs sm:text-sm mb-2">Онлайн — iOS</div>
              ...
              <div className="flex gap-2 sm:gap-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="text-[#dcddde] text-sm sm:text-base">
                    Звонки работают без лагов — это то, чего мне не хватало раньше 👌
                  </div>
                </div>
              </div>
              ...
              <div className="bg-[#2f3136] border border-[#202225] rounded-lg p-4 sm:p-6 mt-6 sm:mt-8">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 mb-4 sm:mb-6">
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-[#b9bbbe] text-xs sm:text-sm">Быстрая регистрация за 30 секунд</p>
                  </div>
                  <div className="text-center">
                    <div className="w-10 h-10 sm:w-12 sm:h-12 bg-[#5865f2] rounded-full flex items-center justify-center mx-auto mb-3">
                    ...
                    <p className="text-[#b9bbbe] text-xs sm:text-sm">Добавь друзей и начни общаться мгновенно</p>
                  </div>
                </div>
                  ...
                  {[
                    {
                      ...
                      desc: "Сообщения приходят мгновенно, без задержек",
                    },
                    {
                    ...
                    },
                    {
                      ...
                      title: "Синхронизация везде",
                      desc: "История чатов на всех устройствах сразу",
                    },
                    {
                      icon: <Shield className="w-4 h-4 sm:w-5 sm:h-5" />,
                      title: "Без рекламы",
                      desc: "Никакой слежки и навязчивых объявлений",
                    },
                  ].map((feature, index) => (
                    <div
                      key={index}
            ...
            <div className="mb-4">
              ...
              <div className="space-y-2">
                {[
                  ...
                  { name: "Алексей", status: "Голосовой чат", avatar: "А", color: "from-blue-500 to-purple-500" },
                ].map((user, index) => (
